...
module PUnCTATest;
	...
	initial begin
		...
		`START_TEST("fib");
		`WAIT_PC_FREEZE;
		`ASSERT_MEM_EQ(21, 16'd1);
		`ASSERT_MEM_EQ(22, 16'd2);
		`ASSERT_MEM_EQ(23, 16'd3);
		`ASSERT_MEM_EQ(24, 16'd5);
		`ASSERT_MEM_EQ(25, 16'd8);
		`ASSERT_MEM_EQ(26, 16'd13);
		`ASSERT_MEM_EQ(27, 16'd21);
		`ASSERT_MEM_EQ(28, 16'd34);
		`ASSERT_MEM_EQ(29, 16'd55);
		`ASSERT_MEM_EQ(30, 16'd89);
		`ASSERT_MEM_EQ(31, 16'd144);
		`ASSERT_MEM_EQ(32, 16'd233);
		`ASSERT_MEM_EQ(33, 16'd377);
		`ASSERT_MEM_EQ(34, 16'd610);
		`ASSERT_MEM_EQ(35, 16'd987);
		`ASSERT_MEM_EQ(36, 16'd1597);
		`ASSERT_MEM_EQ(37, 16'd2584);
		`ASSERT_MEM_EQ(38, 16'd4181);
		`ASSERT_REG_EQ(6, 16'd46368);
